...
using PresetRegisters = std::array<std::uint16_t, registerCount>;

inline constexpr std::array<PresetRegisters, kPresetCount> kPresets {{
    // Room
...
static_assert(registerCount == 32);
